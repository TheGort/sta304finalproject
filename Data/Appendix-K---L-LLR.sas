...
*all;
%ll(depvar=1, kgroup=0);
%ll(depvar=2, kgroup=0);
%ll(depvar=3, kgroup=0);
%ll(depvar=4, kgroup=0);
%ll(depvar=5, kgroup=0);

*hi-ed whites;
%ll(depvar=1, kgroup=3);
%ll(depvar=2, kgroup=3);
%ll(depvar=3, kgroup=3);
%ll(depvar=4, kgroup=3);
%ll(depvar=5, kgroup=3);

*low-ed minorities;
%ll(depvar=1, kgroup=4);
%ll(depvar=2, kgroup=4);
%ll(depvar=3, kgroup=4);
%ll(depvar=4, kgroup=4);
%ll(depvar=5, kgroup=4);
*/
